...
Analysis scripts and notebooks in VibeSpin share a standardized uncertainty schema for all serialized observables. This contract is defined in `utils/analysis.py` and enforced by the integration test layer; any script that writes an NPZ file should conform to it.
